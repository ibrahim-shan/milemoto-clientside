      ...
      <div className="mb-4">
        ...
        <div className="mt-1 flex gap-2">
          <input
            ...
            autoComplete="off"
            className="border-border bg-background placeholder:text-muted-foreground focus-visible:ring-ring flex-1 rounded-xl border px-3 py-2 text-sm outline-none focus-visible:ring-2"
          />
          <Button
            type="button"
            variant="secondary"
